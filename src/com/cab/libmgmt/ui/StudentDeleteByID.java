 ...
 * @author Jack Sparrow
 */
public class StudentDeleteByID extends javax.swing.JPanel {

    /**
     * Creates new form studentUpdateById
     */
    public StudentDeleteByID() {
        initComponents();
    }
    ...
    private void getDataBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getDataBtnActionPerformed
        ...
        try {
            ...
            Logger.getLogger(StudentDeleteByID.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(StudentDeleteByID.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        //Deleting the data on the basis of the id
        Controller controller = new Controller();
        controller.controlDeleteStudent("delete",tempId);
