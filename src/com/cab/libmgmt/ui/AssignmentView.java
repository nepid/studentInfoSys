 ...
 * @author Jack Sparrow
 */
public class AssignmentView extends javax.swing.JPanel {
    ...
    private void viewReportBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewReportBtnActionPerformed
        ...
        String tempQuery = "select * from assignment where sid ='"+tempSid+
                "' and assignment_no="+test_no+" and semester="+sem;
